 ...
 * @extends {ActorSheet}
 */
export class DustChromeActorSheet extends ActorSheet {

  /** @override */
  static get defaultOptions() {
    return mergeObject(super.defaultOptions, {
      classes: ["dustandchrome", "sheet", "actor"],
      template: "systems/dustandchrome/templates/actor/actor-sheet.html",
      width: 600,
      height: 600,
  ...
  /** @override */
  get template() {
    return `systems/dustandchrome/templates/actor/actor-${this.actor.type}-sheet.html`;
  }
